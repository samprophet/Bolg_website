    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://source.unsplash.com/2400x500/?apple,code" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x500/?progeammer,microsoft" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x500/?coding,apple" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
            ...
            <span type="Next" class="sr-only">Next</span>
        </a>
    </div>
    ...
    <!-- categories container starts here -->
        ...
        <div class="row my-4">
         ...
         while($row = mysqli_fetch_assoc($result)){
           ...
           $desc = $row['categories_descripition'];
          echo '<div class="col-md-4 my-2">
                  <div class="card" style="width: 18rem;">
                  <img src="https://source.unsplash.com/500x300/?code,python'. $cat .',coding
